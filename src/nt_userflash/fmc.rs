...
#[doc = "Write proxy for field `READ_IFB`"]
pub struct READ_IFB_W<'a> {
    w: &'a mut W,
}
impl<'a> READ_IFB_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn read_ifb(&mut self) -> READ_IFB_W {
        READ_IFB_W { w: self }
    }
    #[doc = "Bits 16:31 - Code run command. For activate command in MAGIC_KEY write 0xA442"]
    #[inline(always)]
