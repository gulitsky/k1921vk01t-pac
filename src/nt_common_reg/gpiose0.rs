#[doc = "Reader of register GPIOSE0"]
pub type R = crate::R<u32, super::GPIOSE0>;
#[doc = "Writer for register GPIOSE0"]
pub type W = crate::W<u32, super::GPIOSE0>;
#[doc = "Register GPIOSE0 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOSE0 {
    type Type = u32;
    #[inline(always)]
