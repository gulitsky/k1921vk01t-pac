#[doc = "Reader of register GPIODEN0"]
pub type R = crate::R<u32, super::GPIODEN0>;
#[doc = "Writer for register GPIODEN0"]
pub type W = crate::W<u32, super::GPIODEN0>;
#[doc = "Register GPIODEN0 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIODEN0 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:15 - Port A digital output (GPIO or ALTFUNC) enable"]
    #[inline(always)]
    pub fn porta(&self) -> PORTA_R {
        PORTA_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Port B digital output (GPIO or ALTFUNC) enable"]
    #[inline(always)]
