#[doc = "Reader of register GPIOODCTL1"]
pub type R = crate::R<u32, super::GPIOODCTL1>;
#[doc = "Writer for register GPIOODCTL1"]
pub type W = crate::W<u32, super::GPIOODCTL1>;
#[doc = "Register GPIOODCTL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOODCTL1 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Port D open-drain enable"]
    #[inline(always)]
