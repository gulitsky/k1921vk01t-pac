#[doc = "Reader of register GPIOPUCTL1"]
pub type R = crate::R<u32, super::GPIOPUCTL1>;
#[doc = "Writer for register GPIOPUCTL1"]
pub type W = crate::W<u32, super::GPIOPUCTL1>;
#[doc = "Register GPIOPUCTL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOPUCTL1 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:15 - Port C pull-up enable"]
    #[inline(always)]
    pub fn portc(&self) -> PORTC_R {
        PORTC_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Port D pull-up enable"]
    #[inline(always)]
