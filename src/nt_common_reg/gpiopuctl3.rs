#[doc = "Reader of register GPIOPUCTL3"]
pub type R = crate::R<u32, super::GPIOPUCTL3>;
#[doc = "Writer for register GPIOPUCTL3"]
pub type W = crate::W<u32, super::GPIOPUCTL3>;
#[doc = "Register GPIOPUCTL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOPUCTL3 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:15 - Port G pull-up enable"]
    #[inline(always)]
    pub fn portg(&self) -> PORTG_R {
        PORTG_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Port H pull-up enable"]
    #[inline(always)]
