#[doc = "Reader of register GPIODEN3"]
pub type R = crate::R<u32, super::GPIODEN3>;
#[doc = "Writer for register GPIODEN3"]
pub type W = crate::W<u32, super::GPIODEN3>;
#[doc = "Register GPIODEN3 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIODEN3 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Port H digital output (GPIO or ALTFUNC) enable"]
    #[inline(always)]
