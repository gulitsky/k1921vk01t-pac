#[doc = "Reader of register GPIOQM0"]
pub type R = crate::R<u32, super::GPIOQM0>;
#[doc = "Writer for register GPIOQM0"]
pub type W = crate::W<u32, super::GPIOQM0>;
#[doc = "Register GPIOQM0 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOQM0 {
    type Type = u32;
    #[inline(always)]
