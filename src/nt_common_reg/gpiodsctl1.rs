#[doc = "Reader of register GPIODSCTL1"]
pub type R = crate::R<u32, super::GPIODSCTL1>;
#[doc = "Writer for register GPIODSCTL1"]
pub type W = crate::W<u32, super::GPIODSCTL1>;
#[doc = "Register GPIODSCTL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIODSCTL1 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Port D strength control"]
    #[inline(always)]
