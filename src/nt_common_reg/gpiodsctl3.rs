#[doc = "Reader of register GPIODSCTL3"]
pub type R = crate::R<u32, super::GPIODSCTL3>;
#[doc = "Writer for register GPIODSCTL3"]
pub type W = crate::W<u32, super::GPIODSCTL3>;
#[doc = "Register GPIODSCTL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIODSCTL3 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:15 - Port G strength control"]
    #[inline(always)]
    pub fn portg(&self) -> PORTG_R {
        PORTG_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Port H strength control"]
    #[inline(always)]
