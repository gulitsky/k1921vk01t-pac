#[doc = "Reader of register GPIOQE2"]
pub type R = crate::R<u32, super::GPIOQE2>;
#[doc = "Writer for register GPIOQE2"]
pub type W = crate::W<u32, super::GPIOQE2>;
#[doc = "Register GPIOQE2 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOQE2 {
    type Type = u32;
    #[inline(always)]
