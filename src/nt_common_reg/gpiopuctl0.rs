#[doc = "Reader of register GPIOPUCTL0"]
pub type R = crate::R<u32, super::GPIOPUCTL0>;
#[doc = "Writer for register GPIOPUCTL0"]
pub type W = crate::W<u32, super::GPIOPUCTL0>;
#[doc = "Register GPIOPUCTL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOPUCTL0 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Port B pull-up enable"]
    #[inline(always)]
