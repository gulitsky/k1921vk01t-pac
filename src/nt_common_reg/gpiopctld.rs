#[doc = "Reader of register GPIOPCTLD"]
pub type R = crate::R<u32, super::GPIOPCTLD>;
#[doc = "Writer for register GPIOPCTLD"]
pub type W = crate::W<u32, super::GPIOPCTLD>;
#[doc = "Register GPIOPCTLD `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOPCTLD {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Pin D0 alternative function selection\n\nValue on reset: 0"]
...
#[doc = "Pin D1 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN1_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D2 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN2_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D3 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN3_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D4 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN4_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D5 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN5_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D6 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN6_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D7 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN7_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D8 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN8_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D9 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN9_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D10 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN10_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D11 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN11_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D12 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN12_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D13 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN13_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D14 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN14_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
#[doc = "Pin D15 alternative function selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PIN15_A {
    #[doc = "0: first alternative function for pin"]
    ALTFUNC1,
...
impl R {
    #[doc = "Bits 0:1 - Pin D0 alternative function selection"]
    #[inline(always)]
    pub fn pin0(&self) -> PIN0_R {
        PIN0_R::new((self.bits & 0x03) as u8)
    }
    #[doc = "Bits 2:3 - Pin D1 alternative function selection"]
    #[inline(always)]
    pub fn pin1(&self) -> PIN1_R {
        PIN1_R::new(((self.bits >> 2) & 0x03) as u8)
    }
    #[doc = "Bits 4:5 - Pin D2 alternative function selection"]
    #[inline(always)]
    pub fn pin2(&self) -> PIN2_R {
        PIN2_R::new(((self.bits >> 4) & 0x03) as u8)
    }
    #[doc = "Bits 6:7 - Pin D3 alternative function selection"]
    #[inline(always)]
    pub fn pin3(&self) -> PIN3_R {
        PIN3_R::new(((self.bits >> 6) & 0x03) as u8)
    }
    #[doc = "Bits 8:9 - Pin D4 alternative function selection"]
    #[inline(always)]
    pub fn pin4(&self) -> PIN4_R {
        PIN4_R::new(((self.bits >> 8) & 0x03) as u8)
    }
    #[doc = "Bits 10:11 - Pin D5 alternative function selection"]
    #[inline(always)]
    pub fn pin5(&self) -> PIN5_R {
        PIN5_R::new(((self.bits >> 10) & 0x03) as u8)
    }
    #[doc = "Bits 12:13 - Pin D6 alternative function selection"]
    #[inline(always)]
    pub fn pin6(&self) -> PIN6_R {
        PIN6_R::new(((self.bits >> 12) & 0x03) as u8)
    }
    #[doc = "Bits 14:15 - Pin D7 alternative function selection"]
    #[inline(always)]
    pub fn pin7(&self) -> PIN7_R {
        PIN7_R::new(((self.bits >> 14) & 0x03) as u8)
    }
    #[doc = "Bits 16:17 - Pin D8 alternative function selection"]
    #[inline(always)]
    pub fn pin8(&self) -> PIN8_R {
        PIN8_R::new(((self.bits >> 16) & 0x03) as u8)
    }
    #[doc = "Bits 18:19 - Pin D9 alternative function selection"]
    #[inline(always)]
    pub fn pin9(&self) -> PIN9_R {
        PIN9_R::new(((self.bits >> 18) & 0x03) as u8)
    }
    #[doc = "Bits 20:21 - Pin D10 alternative function selection"]
    #[inline(always)]
    pub fn pin10(&self) -> PIN10_R {
        PIN10_R::new(((self.bits >> 20) & 0x03) as u8)
    }
    #[doc = "Bits 22:23 - Pin D11 alternative function selection"]
    #[inline(always)]
    pub fn pin11(&self) -> PIN11_R {
        PIN11_R::new(((self.bits >> 22) & 0x03) as u8)
    }
    #[doc = "Bits 24:25 - Pin D12 alternative function selection"]
    #[inline(always)]
    pub fn pin12(&self) -> PIN12_R {
        PIN12_R::new(((self.bits >> 24) & 0x03) as u8)
    }
    #[doc = "Bits 26:27 - Pin D13 alternative function selection"]
    #[inline(always)]
    pub fn pin13(&self) -> PIN13_R {
        PIN13_R::new(((self.bits >> 26) & 0x03) as u8)
    }
    #[doc = "Bits 28:29 - Pin D14 alternative function selection"]
    #[inline(always)]
    pub fn pin14(&self) -> PIN14_R {
        PIN14_R::new(((self.bits >> 28) & 0x03) as u8)
    }
    #[doc = "Bits 30:31 - Pin D15 alternative function selection"]
    #[inline(always)]
