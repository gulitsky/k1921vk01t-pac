#[doc = "Reader of register GPIODENE"]
pub type R = crate::R<u16, super::GPIODENE>;
#[doc = "Writer for register GPIODENE"]
pub type W = crate::W<u16, super::GPIODENE>;
#[doc = "Register GPIODENE `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIODENE {
    type Type = u16;
    #[inline(always)]
