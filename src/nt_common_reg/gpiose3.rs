#[doc = "Reader of register GPIOSE3"]
pub type R = crate::R<u32, super::GPIOSE3>;
#[doc = "Writer for register GPIOSE3"]
pub type W = crate::W<u32, super::GPIOSE3>;
#[doc = "Register GPIOSE3 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOSE3 {
    type Type = u32;
    #[inline(always)]
