#[doc = "Reader of register GPIODSCTL0"]
pub type R = crate::R<u32, super::GPIODSCTL0>;
#[doc = "Writer for register GPIODSCTL0"]
pub type W = crate::W<u32, super::GPIODSCTL0>;
#[doc = "Register GPIODSCTL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIODSCTL0 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Port B strength control"]
    #[inline(always)]
