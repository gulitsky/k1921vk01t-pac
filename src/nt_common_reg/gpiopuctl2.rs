#[doc = "Reader of register GPIOPUCTL2"]
pub type R = crate::R<u32, super::GPIOPUCTL2>;
#[doc = "Writer for register GPIOPUCTL2"]
pub type W = crate::W<u32, super::GPIOPUCTL2>;
#[doc = "Register GPIOPUCTL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOPUCTL2 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Port F pull-up enable"]
    #[inline(always)]
