#[doc = "Reader of register GPIOQM1"]
pub type R = crate::R<u32, super::GPIOQM1>;
#[doc = "Writer for register GPIOQM1"]
pub type W = crate::W<u32, super::GPIOQM1>;
#[doc = "Register GPIOQM1 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOQM1 {
    type Type = u32;
    #[inline(always)]
