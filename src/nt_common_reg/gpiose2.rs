#[doc = "Reader of register GPIOSE2"]
pub type R = crate::R<u32, super::GPIOSE2>;
#[doc = "Writer for register GPIOSE2"]
pub type W = crate::W<u32, super::GPIOSE2>;
#[doc = "Register GPIOSE2 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOSE2 {
    type Type = u32;
    #[inline(always)]
