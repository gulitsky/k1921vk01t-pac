#[doc = "Reader of register GPIOQM2"]
pub type R = crate::R<u32, super::GPIOQM2>;
#[doc = "Writer for register GPIOQM2"]
pub type W = crate::W<u32, super::GPIOQM2>;
#[doc = "Register GPIOQM2 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOQM2 {
    type Type = u32;
    #[inline(always)]
