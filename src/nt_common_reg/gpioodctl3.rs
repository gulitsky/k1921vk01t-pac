#[doc = "Reader of register GPIOODCTL3"]
pub type R = crate::R<u32, super::GPIOODCTL3>;
#[doc = "Writer for register GPIOODCTL3"]
pub type W = crate::W<u32, super::GPIOODCTL3>;
#[doc = "Register GPIOODCTL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOODCTL3 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Port H open-drain enable"]
    #[inline(always)]
