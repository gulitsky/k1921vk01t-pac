#[doc = "Reader of register GPIOODCTLA"]
pub type R = crate::R<u16, super::GPIOODCTLA>;
#[doc = "Writer for register GPIOODCTLA"]
pub type W = crate::W<u16, super::GPIOODCTLA>;
#[doc = "Register GPIOODCTLA `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOODCTLA {
    type Type = u16;
    #[inline(always)]
