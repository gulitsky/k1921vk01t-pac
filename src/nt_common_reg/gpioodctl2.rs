#[doc = "Reader of register GPIOODCTL2"]
pub type R = crate::R<u32, super::GPIOODCTL2>;
#[doc = "Writer for register GPIOODCTL2"]
pub type W = crate::W<u32, super::GPIOODCTL2>;
#[doc = "Register GPIOODCTL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOODCTL2 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:15 - Port E open-drain enable"]
    #[inline(always)]
    pub fn porte(&self) -> PORTE_R {
        PORTE_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Port F open-drain enable"]
    #[inline(always)]
