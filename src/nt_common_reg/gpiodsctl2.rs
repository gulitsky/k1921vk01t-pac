#[doc = "Reader of register GPIODSCTL2"]
pub type R = crate::R<u32, super::GPIODSCTL2>;
#[doc = "Writer for register GPIODSCTL2"]
pub type W = crate::W<u32, super::GPIODSCTL2>;
#[doc = "Register GPIODSCTL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIODSCTL2 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:15 - Port E strength control"]
    #[inline(always)]
    pub fn porte(&self) -> PORTE_R {
        PORTE_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Port F strength control"]
    #[inline(always)]
