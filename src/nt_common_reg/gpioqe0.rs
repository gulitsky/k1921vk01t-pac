#[doc = "Reader of register GPIOQE0"]
pub type R = crate::R<u32, super::GPIOQE0>;
#[doc = "Writer for register GPIOQE0"]
pub type W = crate::W<u32, super::GPIOQE0>;
#[doc = "Register GPIOQE0 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOQE0 {
    type Type = u32;
    #[inline(always)]
