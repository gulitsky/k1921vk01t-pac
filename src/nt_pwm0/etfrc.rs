#[doc = "Reader of register ETFRC"]
pub type R = crate::R<u32, super::ETFRC>;
#[doc = "Writer for register ETFRC"]
pub type W = crate::W<u32, super::ETFRC>;
#[doc = "Register ETFRC `reset()`'s with value 0"]
impl crate::ResetValue for super::ETFRC {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - activation of an external interrupt EPWMxINT"]
    #[inline(always)]
    pub fn int(&self) -> INT_R {
        INT_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 2 - activation of the external ADC EPWMxSOCA"]
    #[inline(always)]
    pub fn soca(&self) -> SOCA_R {
        SOCA_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - activation of the external ADC EPWMxSOCB"]
    #[inline(always)]
