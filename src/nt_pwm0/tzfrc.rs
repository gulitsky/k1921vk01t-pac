#[doc = "Reader of register TZFRC"]
pub type R = crate::R<u32, super::TZFRC>;
#[doc = "Writer for register TZFRC"]
pub type W = crate::W<u32, super::TZFRC>;
#[doc = "Register TZFRC `reset()`'s with value 0"]
impl crate::ResetValue for super::TZFRC {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 1 - Signal generation(cyclic mode)"]
    #[inline(always)]
    pub fn cbc(&self) -> CBC_R {
        CBC_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Signal generation(single mode)"]
    #[inline(always)]
