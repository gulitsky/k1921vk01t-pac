#[doc = "Reader of register DCCMP"]
pub type R = crate::R<u32, super::DCCMP>;
#[doc = "Writer for register DCCMP"]
pub type W = crate::W<u32, super::DCCMP>;
#[doc = "Register DCCMP `reset()`'s with value 0"]
impl crate::ResetValue for super::DCCMP {
    type Type = u32;
    #[inline(always)]
