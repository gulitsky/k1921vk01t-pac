#[doc = "Reader of register DMAINTMASK"]
pub type R = crate::R<u32, super::DMAINTMASK>;
#[doc = "Writer for register DMAINTMASK"]
pub type W = crate::W<u32, super::DMAINTMASK>;
#[doc = "Register DMAINTMASK `reset()`'s with value 0"]
impl crate::ResetValue for super::DMAINTMASK {
    type Type = u32;
    #[inline(always)]
