...
pub struct RegisterBlock {
    #[doc = "0x00 - Address userflash register"]
    pub fma: FMA,
    #[doc = "0x04 - Data byte user flash register"]
    pub fmd: FMD,
    ...
    pub fcim: FCIM,
    #[doc = "0x14 - Clear status register"]
    pub fcic: FCIC,
