#[doc = "Reader of register SPI_DMACR"]
pub type R = crate::R<u32, super::SPI_DMACR>;
#[doc = "Writer for register SPI_DMACR"]
pub type W = crate::W<u32, super::SPI_DMACR>;
#[doc = "Register SPI_DMACR `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_DMACR {
    type Type = u32;
    #[inline(always)]
