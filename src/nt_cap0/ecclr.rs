#[doc = "Reader of register ECCLR"]
pub type R = crate::R<u32, super::ECCLR>;
#[doc = "Writer for register ECCLR"]
pub type W = crate::W<u32, super::ECCLR>;
#[doc = "Register ECCLR `reset()`'s with value 0"]
impl crate::ResetValue for super::ECCLR {
    type Type = u32;
    #[inline(always)]
