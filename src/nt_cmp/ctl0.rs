...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ASRCP_A {
    #[doc = "0: pin C0+ connected as comparator 0 + in"]
    C0PLUS,
    #[doc = "1: pin C1+ connected as comparator 0 + in"]
    C1PLUS,
    #[doc = "2: DAC 0 out connected as comparator 0 + in"]
    DAC0,
}
...
impl ASRCP_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, ASRCP_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(ASRCP_A::C0PLUS),
            1 => Val(ASRCP_A::C1PLUS),
            2 => Val(ASRCP_A::DAC0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `C0PLUS`"]
    #[inline(always)]
    pub fn is_c0plus(&self) -> bool {
        *self == ASRCP_A::C0PLUS
    }
...
impl<'a> ASRCP_W<'a> {
    ...
    #[doc = "pin C0+ connected as comparator 0 + in"]
    #[inline(always)]
    pub fn c0plus(self) -> &'a mut W {
        self.variant(ASRCP_A::C0PLUS)
    }
    #[doc = "pin C1+ connected as comparator 0 + in"]
    #[inline(always)]
    pub fn c1plus(self) -> &'a mut W {
        self.variant(ASRCP_A::C1PLUS)
    }
    #[doc = "DAC 0 out connected as comparator 0 + in"]
    #[inline(always)]
