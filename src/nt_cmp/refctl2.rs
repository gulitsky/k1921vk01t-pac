#[doc = "Reader of register REFCTL2"]
pub type R = crate::R<u32, super::REFCTL2>;
#[doc = "Writer for register REFCTL2"]
pub type W = crate::W<u32, super::REFCTL2>;
#[doc = "Register REFCTL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::REFCTL2 {
    type Type = u32;
    #[inline(always)]
