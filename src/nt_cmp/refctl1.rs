#[doc = "Reader of register REFCTL1"]
pub type R = crate::R<u32, super::REFCTL1>;
#[doc = "Writer for register REFCTL1"]
pub type W = crate::W<u32, super::REFCTL1>;
#[doc = "Register REFCTL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::REFCTL1 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 8 - range of the DAC"]
    #[inline(always)]
    pub fn rng(&self) -> RNG_R {
        RNG_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - power to the built-in DAC"]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
