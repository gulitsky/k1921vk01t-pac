...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TSVAL_A {
    #[doc = "0: pin C1+ connected as comparator 1 + in"]
    C1PLUS,
    #[doc = "2: DAC 1 out connected as comparator 1 + in"]
    DAC1,
    #[doc = "3: DAC 0 out connected as comparator 1 + in"]
    DAC0,
}
...
impl TSVAL_R {
    ...
    pub fn variant(&self) -> crate::Variant<bool, TSVAL_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(TSVAL_A::C1PLUS),
            true => Val(TSVAL_A::DAC1),
...
impl<'a> TSVAL_W<'a> {
    ...
    #[doc = "pin C1+ connected as comparator 1 + in"]
    #[inline(always)]
    pub fn c1plus(self) -> &'a mut W {
        self.variant(TSVAL_A::C1PLUS)
    }
    #[doc = "DAC 1 out connected as comparator 1 + in"]
    #[inline(always)]
    pub fn dac1(self) -> &'a mut W {
        self.variant(TSVAL_A::DAC1)
    }
    #[doc = "DAC 0 out connected as comparator 1 + in"]
    #[inline(always)]
